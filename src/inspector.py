...
class inspector():
	...
	def create_frames(self):
		...
		self.btn_area_frame = tkinter.Frame(self.root, bg="blue", height=i_config.BTN_FRAME_HEIGHT)
	...
	def create_buttons(self):
		...
		self.submit_btn.config(width=i_config.BTN_WIDTH, height=i_config.BTN_HEIGHT)
		...
		self.clear_btn.config(width=i_config.BTN_WIDTH, height=i_config.BTN_HEIGHT)
